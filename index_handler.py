...
INDEXES = [
    ...
    ("الروايات والقصص", "novels_stories", ["رواية", "قصّة", "قصة", "novel", "fiction", "أدب", "قصصية"]),
    ...
    ("التحليل النفسي", "psy_analysis", ["تحليل", "سلوك", "شخصية"]),
    ...
    ("الفكر والثقافة", "culture", ["ثقافة", "فكر", "مقال", "مناقشة"]),
    ("علم البيئة", "environment", ["بيئة", "طبيعة", "مناخ", "حيوانات"]),
    ("التنمية البشرية", "self_development", ["تطوير", "تنمية", "شخصية", "مهارات"]),
    ("العلوم الاجتماعية", "social_sciences", ["مجتمع", "ثقافة", "سلوك", "علاقات"]),
    ("الإعلام والصحافة", "media_journalism", ["إعلام", "صحافة", "تلفزيون", "راديو"]),
]
...
# -----------------------------
# البحث داخل الفهرس وعرض الكتب (صارم حسب الكلمات الأساسية)
# -----------------------------
async def search_by_index(update, context: ContextTypes.DEFAULT_TYPE):
    ...
    and_conditions = " AND ".join([f"LOWER(file_name) LIKE '%{k}%'" for k in keywords])
